...
- **Độ ổn định test nội bộ:** Đạt (`63/63` pass).
...
5. `test_parser_handles_robust_prompt_cases` — case 0 — PASS  
6. `test_parser_handles_robust_prompt_cases` — case 1 — PASS  
7. `test_parser_handles_robust_prompt_cases` — case 2 — PASS  
8. `test_parser_handles_robust_prompt_cases` — case 3 — PASS  
9. `test_parser_handles_robust_prompt_cases` — case 4 — PASS  
10. `test_parser_handles_robust_prompt_cases` — case 5 — PASS  
11. `test_parser_handles_robust_prompt_cases` — case 6 — PASS  
12. `test_parser_handles_robust_prompt_cases` — case 7 — PASS  
13. `test_parser_handles_robust_prompt_cases` — case 8 — PASS  
14. `test_parser_handles_robust_prompt_cases` — case 9 — PASS  
15. `test_parser_handles_robust_prompt_cases` — case 10 — PASS  
16. `test_parser_handles_robust_prompt_cases` — case 11 — PASS  
17. `test_parser_handles_robust_prompt_cases` — case 12 — PASS  
18. `test_parser_handles_robust_prompt_cases` — case 13 — PASS  
19. `test_parser_handles_robust_prompt_cases` — case 14 — PASS  
20. `test_parser_handles_robust_prompt_cases` — case 15 — PASS  
21. `test_parser_handles_robust_prompt_cases` — case 16 — PASS  
22. `test_parser_handles_robust_prompt_cases` — case 17 — PASS  
23. `test_parser_handles_robust_prompt_cases` — case 18 — PASS  
24. `test_parser_handles_robust_prompt_cases` — case 19 — PASS  
25. `test_parser_handles_robust_prompt_cases` — case 20 — PASS  
26. `test_parser_handles_robust_prompt_cases` — case 21 — PASS  
27. `test_parser_handles_robust_prompt_cases` — case 22 — PASS  
28. `test_parser_handles_robust_prompt_cases` — case 23 — PASS  
29. `test_parser_handles_robust_prompt_cases` — case 24 — PASS  
30. `test_parser_handles_robust_prompt_cases` — case 25 — PASS  
31. `test_parser_handles_robust_prompt_cases` — case 26 — PASS  
32. `test_parser_handles_robust_prompt_cases` — case 27 — PASS  
33. `test_parser_handles_robust_prompt_cases` — case 28 — PASS  
34. `test_parser_handles_robust_prompt_cases` — case 29 — PASS  
35. `test_parser_handles_robust_prompt_cases` — case 30 — PASS  
36. `test_parser_handles_robust_prompt_cases` — case 31 — PASS  
37. `test_parser_handles_robust_prompt_cases` — case 32 — PASS  
38. `test_parser_handles_robust_prompt_cases` — case 33 — PASS  
39. `test_parser_handles_robust_prompt_cases` — case 34 — PASS  
40. `test_parser_handles_robust_prompt_cases` — case 35 — PASS  
41. `test_parser_fallback_for_provider_failures` — case 0 — PASS  
42. `test_parser_fallback_for_provider_failures` — case 1 — PASS  
43. `test_parser_fallback_for_provider_failures` — case 2 — PASS  
44. `test_parser_fallback_for_empty_prompt_without_llm_call` — PASS  
45. `test_parser_handles_advanced_failure_and_edge_cases` — case 0 — PASS  
46. `test_parser_handles_advanced_failure_and_edge_cases` — case 1 — PASS  
47. `test_parser_handles_advanced_failure_and_edge_cases` — case 2 — PASS  
48. `test_parser_handles_advanced_failure_and_edge_cases` — case 3 — PASS  
49. `test_parser_handles_advanced_failure_and_edge_cases` — case 4 — PASS  
50. `test_parser_handles_advanced_failure_and_edge_cases` — case 5 — PASS  
51. `test_parser_handles_advanced_failure_and_edge_cases` — case 6 — PASS  
52. `test_parser_handles_advanced_failure_and_edge_cases` — case 7 — PASS  
53. `test_parser_handles_advanced_failure_and_edge_cases` — case 8 — PASS  
54. `test_parser_handles_advanced_failure_and_edge_cases` — case 9 — PASS  
55. `test_parser_handles_advanced_failure_and_edge_cases` — case 10 — PASS  
56. `test_parser_handles_advanced_failure_and_edge_cases` — case 11 — PASS  
57. `test_parser_handles_advanced_failure_and_edge_cases` — case 12 — PASS  
58. `test_parser_handles_advanced_failure_and_edge_cases` — case 13 — PASS  
59. `test_parser_handles_advanced_failure_and_edge_cases` — case 14 — PASS  
60. `test_parser_handles_advanced_failure_and_edge_cases` — case 15 — PASS  
