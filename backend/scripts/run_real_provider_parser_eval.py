...
DEFAULT_PROMPTS: list[str] = [
    ...
    "Trời mưa to, mình chỉ muốn đi trong nhà thôi.",
    "Trời mưa nhưng tôi vẫn muốn đi dạo ngoài trời và chụp ảnh.",
    "Mưa nhẹ cũng được, ưu tiên điểm ngoài trời nếu đẹp.",
            ...
            json.dumps(
                {
                    ...
                    "avoid_outdoor_in_rain": result.avoid_outdoor_in_rain,
